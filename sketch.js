...
function preload(){
car_driving= loadImage("Car.jpg");
car_crashed= loadImage("Car crashed.jpg")

roadImage= loadImage("Road image.jpg");
oil_canImage= loadImage("oil_can.1.jpg");
truckImage= loadImage("truck.1.jpg");
...
function setup(){
  ...
  car.addImage("driving", car_driving);
  car.addImage("crashed", car_crashed);
  car.scale= 0.5;

  oil_can = createSprite()
  road = createSprite(400,450,50,20);
